...
- 0ffa7f0: Extend the `init`/`add` scaffold wizard with three more independently skippable, multi-select prompts covering more of the package's built-in modules:
